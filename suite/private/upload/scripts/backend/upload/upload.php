...
const HOME_SCHEDULE_FILE = __DIR__ . DIRECTORY_SEPARATOR;
const PARSER_EXECUTABLE_FILE = __DIR__ . DIRECTORY_SEPARATOR;
const EMBED_WORKING_DIRECTORY = __DIR__ . DIRECTORY_SEPARATOR;
const UPLOAD_WORKING_DIRECTORY = __DIR__ . DIRECTORY_SEPARATOR;
